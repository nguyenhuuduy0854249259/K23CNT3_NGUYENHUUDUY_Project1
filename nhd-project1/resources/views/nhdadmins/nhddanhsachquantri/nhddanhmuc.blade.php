            ...
            <div class="col-md-4">
                <div class="card text-center shadow-lg">
                    <div class="card-body bg-primary text-white">
                        ...
                        <a href="/nhd-admins/nhddanhsachquantri/nhdsanpham" class="btn btn-outline-light">Xem Sản Phẩm</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow-lg">
                    <div class="card-body bg-info text-white">
                        ...
                        <a href="{{route('nhdadmins.nhddanhsachquantri.danhmuc.tintuc')}}" class="btn btn-outline-light">Xem Tin Tức</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow-lg">
                    <div class="card-body bg-success text-white">
                        ...
                        <a href="/nhd-admins/nhddanhsachquantri/nhdnguoidung" class="btn btn-outline-light">Xem Người Dùng</a>
                    </div>
                </div>
            </div>
        </div>
